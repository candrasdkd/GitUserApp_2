...
import com.example.learn.myproject.databinding.ActivityCardUserBinding
...
class UserAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = ActivityCardUserBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MyViewHolder(private var binding: ActivityCardUserBinding) :
