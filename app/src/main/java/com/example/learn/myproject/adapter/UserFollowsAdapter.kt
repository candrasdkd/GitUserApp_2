...
import com.example.learn.myproject.databinding.ActivityCardUserFollowBinding
...
class UserFollowsAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = ActivityCardUserFollowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MyViewHolder(private var binding:  ActivityCardUserFollowBinding) :
