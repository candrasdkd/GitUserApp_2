...
import com.example.learn.myproject.adapter.UserFollowsAdapter
import com.example.learn.myproject.databinding.FragmentUserFollowerBinding
...
class UserFollowerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUserFollowerBinding.inflate(inflater, container, false)
    ...
    private fun setViewModel(username: String, index: Int) {
        val followsViewModel: UserFollowerViewModel by viewModels {
            UserFollowerViewModelFactory(username)
        }
